...
export default function Hero() {
  ...
  const bgType = settings?.hero_bg_type || "gradient";
    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-4 text-center">
        <div className="mb-6 animate-fade-in">
          <Image src="/images/logo.png" alt="Paullada DJ" width={140} height={140} className="mx-auto" />
        </div>
        ...
        <p className="animate-fade-in mb-2 max-w-2xl text-lg leading-relaxed text-zinc-400 md:text-xl" style={{ animationDelay: "0.3s" }}>
          {settings?.description || "O Melhor do Flashback"}
        </p>
        ...
        <a
          href={settings?.instagram ? `https://instagram.com/${settings.instagram}` : "https://www.instagram.com/paulladadjrj"}
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => track("clique", "hero", "instagram")}
          className="animate-fade-in flex items-center gap-3 rounded-full bg-gradient-to-r from-logo-gold to-gold px-8 py-4 text-base font-bold text-white shadow-lg shadow-gold/30 transition-all hover:scale-105 hover:shadow-xl hover:shadow-gold/50"
